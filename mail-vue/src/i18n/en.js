const en = {
    ux: {
        "searchAction": "Search",
        "codeSearch": "Search service, subject or recipient",
        "codeWindow": "Received",
        "recentWindow": "Last 15 minutes",
        "olderWindow": "Earlier records",
        "codeHelpTitle": "Display window & privacy",
        "codeHelp": "Codes can be copied here within a 15-minute display window, not a guarantee of validity. Earlier values are hidden; the original email remains available.",
        "codeRecent": "Recently received",
        "codeReceivedMinutes": "Received {minutes} min ago",
        "codeHiddenPolicy": "Outside the display window",
        "codeHiddenValue": "Code hidden",
        "codeWait": "Wait for a code",
        "codeStopWait": "Stop waiting",
        "codeWaiting": "Waiting for new codes",
        "codePaused": "Checks pause while this tab is hidden",
        "codeLastCheck": "Last checked {time}",
        "codeCheckFailed": "Check failed. Retrying automatically.",
        "codeNew": "Show {count} new codes",
        "codeOriginal": "View email",
        "codeCopyDone": "Code copied",
        "codeEmptyTitle": "No recent codes yet",
        "codeEmptyHelp": "Verification emails will appear here. Start waiting for a new code or refresh later.",
        "codeNoMatch": "No matching codes",
        "codeClearSearch": "Clear search",
        "codeFrom": "From",
        "codeTo": "Recipient",
        "moreActions": "More actions",
        "writerOpenFailed": "Could not open the editor. Please retry.",
        "writerLoading": "Opening editor",
        "draftCloseTitle": "What would you like to do with this message?",
        "draftCloseHint": "Drafts are stored in this browser only, not synced to other devices.",
        "draftKeepEditing": "Keep editing",
        "draftSaveClose": "Save draft & close",
        "draftDiscard": "Discard changes",
        "draftSaveFailed": "Could not save the draft. Your message remains in the editor. Please retry.",
        "draftSavedLocal": "Saved to local drafts",
        "editorFailed": "The editor could not load. Your existing content is preserved. Check your connection and retry.",
        "editorRetry": "Reload editor",
